...
BOT_TOKEN = environ.get('BOT_TOKEN', '6736884905:AAFjfwMnEEiJBYYugERGRefwLsNMp0HVvC4')
# Bot settings
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@JINN_GROUP')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "JOIN_@JINN_GROUP)
