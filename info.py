...
SUPPORT_CHAT = os.environ.get('SUPPORT_CHAT', 'TamilanBotsZ_Support')
...
UPSTREAM_REPO = os.environ.get('UPSTREAM_REPO', 'https://github.com/TamilanBotsZ/AwesomeFilterPro')
